...
MODEL                   = North_Country_Grid
MODULES                 = rt_matrx.c rt_printf.c North_Country_Grid.c North_Country_Grid_capi.c North_Country_Grid_data.c North_Country_Grid_tgtconn.c rtGetInf.c rt_look.c rt_look1d.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_discreteVariableDelay.c
PRODUCT                 = North_Country_Grid
MAKEFILE                = North_Country_Grid.mk
MATLAB_ROOT             = /Applications/MATLAB_R2024b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2024b.app
START_DIR               = /Users/prankfarsons/Documents/GitHub/Clarkson-PwrEng-REU/North_Country_Grid
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
COMPUTER                = MACA64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/North_Country_Grid \
